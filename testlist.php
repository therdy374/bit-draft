                            ...
                            <div>
                                <ul>
                                    <li id="menuNotice" class="active">
                                        <a style="display: block;" href="testlist.php?id=notice">공지사항</a>
                                    </li>
                                    <li id="menuFaq">
                                        <a style="display: block;" href="List.php?id=faq">이용안내</a>
                                    </li>
                                </ul>
                                <div>
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="Viewlist.php?id=notice&amp;rno=2&amp;page=1">아이스크림 맛잇써
                                                    </a></td>
                                                <td>본사</td>
                                            ...
                                            <tr>
                                                <td><a href="Viewlist.php?id=notice&amp;rno=1&amp;page=1">안녕하세요?
                                                    </a></td>
                                                <td>본사</td>
                                    ...
                                    <div class="pagenation">
                                        <ol>
                                            <li><a href="/Notice.php?id=notice&amp;page=1" class="active">1</a></li>
                                        </ol>
                                    </div>
                                    <!-- pagenation -->
                                </div>
