                    ...
                    <div class="frameWrapper">
                        ...
                        <div class="invest_wrap">
                            ...
                            <section id="cpContent_title1" class="noticeContainer">
                                <div>
                                    <ul>
                                        <li id="menuNotice" class="menu-item active">
                                            <a style="display: block;" href="javascript:void(0);">공지사항</a>
                                        </li>
                                        <li id="menuFaq" class="menu-item">
                                            <a style="display: block;" href="javascript:void(0);">이용안내</a>
                                        </li>
                                    </ul>
                                    <div>
                                        <!-- Notice content -->
                                        <table id="contentNotice" class="content-table">
                                            <tbody>
                                                <tr>
                                                    <th>제목</th>
                                                    <th>작성자</th>
                                                ...
                                                <tr>
                                                    <td><a href="Viewlist.php?id=notice&amp;rno=2&amp;page=1">아이스크림 맛잇써</a></td>
                                                    <td>본사</td>
                                                    <td>2024-09-11 오후 6:50:57</td>
                                                </tr>
                                                <tr>
                                                    <td><a href="Viewlist.php?id=notice&amp;rno=1&amp;page=1">안녕하세요?</a></td>
                                                    <td>본사</td>
                                                    <td>2024-09-11 오후 6:38:44</td>
                                                </tr>
                                            </tbody>
                                        </table>

                                        <!-- FAQ content, initially hidden -->
                                        <table id="contentFaq" class="content-table" style="display: none;">
                                            <tbody>
                                                <tr>
                                                    <th>제목</th>
                                                    <th>작성자</th>
                                                ...
                                                <tr>
                                                    <td><a href="Viewlist.php?id=faq&amp;rno=2&amp;page=1">FAQ 아이템</a></td>
                                                    <td>본사</td>
                                                    <td>2024-09-11 오후 6:50:57</td>
                                                </tr>
                                            </tbody>
                            ...
                            <script>
                                ...
                                const contentFaq = document.getElementById('contentFaq');
                                ...
                                menuItems.forEach(item => {
                                    item.addEventListener('click', function() {
                                        ...
                                        // Show/hide content based on the clicked menu
                                        if (this.id === 'menuNotice') {
                                            contentNotice.style.display = 'table';
                                            contentFaq.style.display = 'none';
                                        } else if (this.id === 'menuFaq') {
                                            contentNotice.style.display = 'none';
                                            contentFaq.style.display = 'table';
                                        }
                                    });
                                });
                            </script>
