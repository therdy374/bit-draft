<?php
// Database connection and session setup remain the same
session_start();
    ...
    if ($stmt->execute()) {
        ...
        if ($stmt->execute()) {
            echo json_encode([
                ...
                'currentBal' => number_format($newCreditLimit, 2, '.', ''), // Format the current balance to 2 decimal points
...
<body>
    ...
    <div id="history_area" class="history_wrap">
        <div id="history-div" class="history_area">
            ...
            // Debugging line to show the logged-in user (optional)
            echo "Logged in user: " . htmlspecialchars($userid);
            ...
            ?>
                        ...
                        <div id="tradHistoryTab1" class="trade_list tabPage active">
                            <div class="summary">
                                ...
                                <dl>
                                    <dt><span id="marginText">Total Margin</span> USDT</dt>
                                    <dd><span class="totlaBalancePoint"><?= number_format($usd_amount, 2) ?></span></dd>
                                </dl>
                                <dl>
                                    <dt>Profit USDT</dt>
                                    <dd id="sum-settle-tp" class="minus">USDT</dd>
                                </dl>
                                <dl>
                                    <dt>Profit Rate</dt>
                                    <dd id="sum-settle-rate" class="minus">%</dd>
                                </dl>
                            </div>
                        </div>
