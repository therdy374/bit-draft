...
<body class="nav-md" id="toremoveonlogin">
    <div class="container body">
        <div class="main_container">
            ...
            <form method="post" action="./BalancePartnerLog.aspx" id="form2">
                <div class="aspNetHidden">
                    <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
                        value="/wEPDwULLTE5ODE0MjQ3MTEPZBYCZg9kFgoCBQ8WAh4HVmlzaWJsZWdkAgYPFgIfAGdkAgcPFgIfAGdkAggPFgIfAGdkAgkPZBYCAgEPZBYEAgkPFgIeBFRleHRlZAILDxYCHwFlZGRNpGbd6utjZrxwFG0/xgUwpU1mpnCuSbrD241CKmiDmw==">
                </div>

                <div class="aspNetHidden">

                    <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="14AD1287">
                    <input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION"
                        value="/wEdAAUqqW5cVH8ttV2l3UlRbXvHfWYMVElfuUNHjS59ypg8pegSm0mEtHB7LEQqukvBT+TnEfIVTZ/oRyVsHWLocCgRn4j8c9nzo0RlxtfBH2PEDtofy51I9bqq9tZyvRtr9529M3GxUosl9iE0JXO26m0e">
                </div>
                <!-- page content -->
                <div class="right_col" role="main" style="min-height: 613px;">
                                ...
                                <div class="x_content">
                                    <div class="form-inline">
                                        ...
                                        <div class="form-group search-form-group">
                                            ...
                                            <input name="ctl00$MainContent$txtSPartnerId" type="text"
                                                id="MainContent_txtSPartnerId" class="form-control mobile-wide2"
                                                placeholder="">
                                        </div>
