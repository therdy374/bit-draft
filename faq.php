                    ...
                    <div class="invest_wrap">
                        ...
                        <section id="cpContent_title1" class="noticeContainer">
                            <div>
                                <ul>
                                    <li id="menuNotice">
                                        <a style="display: block;" href="/Board/List.aspx?id=notice">공지사항</a>
                                    </li>
                                    <li id="menuFaq" class="active">
                                        <a style="display: block;" href="/Board/List.aspx?id=faq">이용안내</a>
                                    </li>
                                </ul>
                                <div>
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="/Board/View.aspx?id=faq&amp;rno=1&amp;page=1">안녕하세요? </a></td>
                                                <td>본사</td>
                                                <td>2024-09-11 오후 6:51:19</td>
                                            </tr>
                                    ...
                                    <div class="pagenation">
                                        <ol>
                                            <li><a href="/Notice.aspx?id=faq&amp;page=1" class="active">1</a></li>
                                        </ol>
                                    </div>
                                    <!-- pagenation -->
                                </div>
